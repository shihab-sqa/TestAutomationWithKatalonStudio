...
WebUI.setText(findTestObject('Object Repository/Login/Page_Test Login  Practice Test Automation/input_Username_username'), 
    'student')

WebUI.setEncryptedText(findTestObject('Object Repository/Login/Page_Test Login  Practice Test Automation/input_Password_password'), 
